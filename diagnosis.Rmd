...
Embed plot of diagnosis x Mean Compactness:

```{r, echo=FALSE}
plot(x = diagnosis_data_full$diagnosis, y = diagnosis_data_full$texture_mean)
```
...
#### Build first Model based on Mean values
